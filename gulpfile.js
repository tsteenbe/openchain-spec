...
const outputDir = './dist/',
    ...
    del = require('del'),
    documentName = 'openchain-specification',
...
gulp.task('html', 'Generate HTML website in ' + outputDir, ['clean-build-html','build-html', 'git-hash'], (cb) => {
    ...
    gulp.src([
        ...
        .pipe(cheerio(($, file) => {
          ...
          $('meta[name="author"]')
          .append('\n<meta name="DC.source" content="https://github.com/tsteenbe/openchain-spec">')
          .append('\n<meta name="DC.identifier" content="#' + gitHash + '">')
          .append('\n<meta name="DC.date.created" content="' + (new Date).toISOString() + '">')
          .append('\n<meta name="DC.rights" content="SPDX-License-Identifier: CC-BY-4.0">');
          
          // Insert OpenChain logo
          $('.book-summary ul.summary li a.gitbook-link')
          .parent().prepend('\n<a class="logo" href="https://www.openchainproject.org" target="_blank"><span class="logo"/></a>')
        }))
